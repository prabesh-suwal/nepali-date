...
public final class NepaliCalendarData {
    ...
    static {
         ...
         * ─────────────────────────────────────────────────────────────────────
         */
        Map<Integer, int[]> map = new HashMap<>(210);
        ...
        map.put(1902, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1903, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1904, new int[]{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}); // 365
        map.put(1905, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1906, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1907, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1908, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(1909, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365

        // ── 1910–1919 ──────────────────────────────────────────────────────
        map.put(1910, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1911, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1912, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1913, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1914, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1915, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1916, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1917, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1918, new int[]{31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1919, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}); // 366

        // ── 1920–1929 ──────────────────────────────────────────────────────
        map.put(1920, new int[]{31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1921, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1922, new int[]{31, 31, 32, 32, 31, 30, 30, 30, 29, 29, 30, 30}); // 365
        map.put(1923, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}); // 366
        map.put(1924, new int[]{31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1925, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1926, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1927, new int[]{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31}); // 365
        map.put(1928, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1929, new int[]{31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 1930–1939 ──────────────────────────────────────────────────────
        map.put(1930, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1931, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31}); // 365
        map.put(1932, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1933, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1934, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1935, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(1936, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1937, new int[]{31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1938, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1939, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365

        // ── 1940–1949 ──────────────────────────────────────────────────────
        map.put(1940, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1941, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1942, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1943, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1944, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1945, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1946, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1947, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1948, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1949, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 1950–1959 ──────────────────────────────────────────────────────
        map.put(1950, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1951, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(1952, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1953, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1954, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1955, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(1956, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1957, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1958, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1959, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365

        // ── 1960–1969 ──────────────────────────────────────────────────────
        map.put(1960, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1961, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1962, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1963, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1964, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1965, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1966, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1967, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1968, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1969, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 1970–1979 ──────────────────────────────────────────────────────
        map.put(1970, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1971, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1972, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1973, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1974, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1975, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1976, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1977, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1978, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1979, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365

        // ── 1980–1989 ──────────────────────────────────────────────────────
        map.put(1980, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1981, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1982, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1983, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1984, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1985, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1986, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1987, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1988, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1989, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 1990–1999 ──────────────────────────────────────────────────────
        map.put(1990, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1991, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1992, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1993, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1994, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1995, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(1996, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1997, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(1998, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(1999, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365

        // ══════════════════════════════════════════════════════════════════════
        // BS 2000 – 2099  (modern data; high-confidence cross-referenced sources)
        // ══════════════════════════════════════════════════════════════════════
        ...
        map.put(2031, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31}); // 365
        ...
        map.put(2035, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(2036, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2037, new int[]{31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        ...
        map.put(2049, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 2050–2059 ──────────────────────────────────────────────────────
        map.put(2050, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2051, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(2052, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2053, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2054, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2055, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(2056, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2057, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2058, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2059, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365

        // ── 2060–2069 ──────────────────────────────────────────────────────
        map.put(2060, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2061, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2062, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2063, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2064, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2065, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2066, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2067, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2068, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2069, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 2070–2079 ──────────────────────────────────────────────────────
        map.put(2070, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2071, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2072, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2073, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2074, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2075, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2076, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2077, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2078, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2079, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365

        // ── 2080–2089 ──────────────────────────────────────────────────────
        map.put(2080, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2081, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2082, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2083, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2084, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2085, new int[]{31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2086, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2087, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2088, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2089, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365

        // ── 2090–2099 ──────────────────────────────────────────────────────
        map.put(2090, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2091, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2092, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2093, new int[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2094, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2095, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30}); // 365
        map.put(2096, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
        map.put(2097, new int[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31}); // 366
        map.put(2098, new int[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 29, 31}); // 365
        map.put(2099, new int[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30}); // 365
